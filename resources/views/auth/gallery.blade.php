    ...
    <div class="row">
        <div class="col-md-12">
            <h4 class="add-image-button">
                <a href="{{ url('add-gallery') }}" class="btn btn-danger btn-sm">ADD PICTURE</a>
            </h4>
                        ...
                        @foreach ($gallery as $item)
                            <div class="col-md-4 mb-4">
                                <div class="card custom-card">
                                    <img src="{{ asset('uploads/galleries/'.$item->image) }}" class="card-img-top" alt="Image">
                                    <div class="card-body">
                                        <h5 class="card-title">{{ $item->des_a }}</h5>
                                        <p class="card-text">{{ $item->des_b }}</p>
                                    </div>
                                    <div class="card-footer">
                                        <a href="{{ url('edit-gallery/'.$item->id) }}" class="btn btn-primary btn-sm">Edit</a>
                                        <h5></h5>
